...
from .cons_and_vars import cv, settings, WORKING_DIRECTORY
...
class MyButton(QPushButton):
    ...
    def button_clicked_action(self):
        ...
        app_launcher = settings['buttons'][self.button_number]['app_launcher']
        app_path = settings['buttons'][self.button_number]['app_path']
